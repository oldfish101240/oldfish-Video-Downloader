...
## 如何安裝
1. 下載[最新版本](https://github.com/oldfish101240/oldfish-Video-Downloader/releases/latest)至電腦中的任何位置  
2. 解壓縮oldfish_downloader_vX.X.X.7z  
...
## 已知問題   
1. 下載的影片可能無法播放，可能是電腦不支援該編碼器，可以從Microsoft Store下載視訊延伸模組，或嘗試改用第三方影片播放器(如potplayer)  
2. 本軟體可能會被您的防毒軟體偵測為病毒，即使本軟體並不是病毒。如要解決此問題，請至您的防毒軟體將本軟體設為排除項目  
